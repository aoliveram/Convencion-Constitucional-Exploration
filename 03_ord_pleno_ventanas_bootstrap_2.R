...
write.csv(ordenamiento_1D_WNOM_al_14ago2021_bootstrap, 
          file = "Pleno/ordenamientos_pleno/ordenamiento_1D_WNOM_al-14ago2021_bootstrap.csv", 
          row.names = FALSE)
...
votaciones_22_37 <-read.csv("Pleno/votaciones_22_37.csv") # 598 votaciones
...
write.csv(ordenamiento_1D_WNOM_22_37_bootstrap, 
          file = "Pleno/ordenamientos_pleno/ordenamiento_1D_WNOM_22-37_bootstrap.csv", 
          row.names = FALSE)
...
write.csv(ordenamiento_1D_WNOM_38_46_bootstrap, 
          file = "Pleno/ordenamientos_pleno/ordenamiento_1D_WNOM_38-46_bootstrap.csv", 
          row.names = FALSE)

ordenamiento_1D_WNOM_38_46_bootstrap <- read.csv(
  "Pleno/ordenamientos_pleno/ordenamiento_1D_WNOM_38-46_bootstrap.csv",
  stringsAsFactors = FALSE,  # Preserve string formatting
  encoding = "UTF-8"         # Maintain special characters
)
...
votaciones_47_55 <-read.csv("Pleno/votaciones_47_55.csv") # 64 votaciones
...
write.csv(ordenamiento_1D_WNOM_47_55_bootstrap, 
          file = "Pleno/ordenamientos_pleno/ordenamiento_1D_WNOM_47-55_bootstrap.csv", 
          row.names = FALSE)

ordenamiento_1D_WNOM_47_55_bootstrap <- read.csv(
  "Pleno/ordenamientos_pleno/ordenamiento_1D_WNOM_47-55_bootstrap.csv",
  stringsAsFactors = FALSE,  # Preserve string formatting
  encoding = "UTF-8"         # Maintain special characters
)
...
votaciones_56_75 <-read.csv("Pleno/votaciones_56_75.csv") # 899 votaciones
...
write.csv(ordenamiento_1D_WNOM_56_75_bootstrap, 
          file = "Pleno/ordenamientos_pleno/ordenamiento_1D_WNOM_56-75_bootstrap.csv", 
          row.names = FALSE)

ordenamiento_1D_WNOM_56_75_bootstrap <- read.csv(
  "Pleno/ordenamientos_pleno/ordenamiento_1D_WNOM_56-75_bootstrap.csv",
  stringsAsFactors = FALSE,  # Preserve string formatting
  encoding = "UTF-8"         # Maintain special characters
)
...
write.csv(ordenamiento_1D_WNOM_76_99_bootstrap, 
          file = "Pleno/ordenamientos_pleno/ordenamiento_1D_WNOM_76-99_bootstrap.csv", 
          row.names = FALSE)

ordenamiento_1D_WNOM_76_99_bootstrap <- read.csv(
  "Pleno/ordenamientos_pleno/ordenamiento_1D_WNOM_76-99_bootstrap.csv",
  stringsAsFactors = FALSE,  # Preserve string formatting
  encoding = "UTF-8"         # Maintain special characters
)
...
votaciones_100_106 <-read.csv("Pleno/votaciones_100_106.csv") # 514 votaciones
...
write.csv(ordenamiento_1D_WNOM_100_106_bootstrap, 
          file = "Pleno/ordenamientos_pleno/ordenamiento_1D_WNOM_100-106_bootstrap.csv", 
          row.names = FALSE)

ordenamiento_1D_WNOM_100_106_bootstrap <- read.csv(
  "Pleno/ordenamientos_pleno/ordenamiento_1D_WNOM_100-106_bootstrap.csv",
  stringsAsFactors = FALSE,  # Preserve string formatting
  encoding = "UTF-8"         # Maintain special characters
)
...
write.csv(ordenamiento_1D_WNOM_107_109_bootstrap, 
          file = "Pleno/ordenamientos_pleno/ordenamiento_1D_WNOM_107-109_bootstrap.csv", 
          row.names = FALSE)

ordenamiento_1D_WNOM_107_109_bootstrap <- read.csv(
  "Pleno/ordenamientos_pleno/ordenamiento_1D_WNOM_107-109_bootstrap.csv",
  stringsAsFactors = FALSE,  # Preserve string formatting
  encoding = "UTF-8"         # Maintain special characters
)
