...
output_file <- "ideological-scaling-files/ideological-scaling-files/03_orden_votantes_t_MCMC.csv"
...
saveRDS(orden_votantes_t_mcmc, "ideological-scaling-files/ideological-scaling-files/03_orden_votantes_t_MCMC.rds")

orden_votantes_t_mcmc <- readRDS("ideological-scaling-files/ideological-scaling-files/03_orden_votantes_t_MCMC.rds")
