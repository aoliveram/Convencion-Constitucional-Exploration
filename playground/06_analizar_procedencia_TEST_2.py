...
# Esto encontrará "1.- Artículo", "499.- Artículo", etc.
...
# El resultado de re.split es una lista como:
# ['', '1', ' 2°.- Democracia paritaria...', '2', ' 3°.- ...', '3', ' X.- ...']
# El primer elemento es basura (texto antes del primer artículo).
# Después, se alterna entre el ID capturado y el cuerpo del artículo.
