...
orden_votantes_t_procesado <- orden_votantes_t %>%
  mutate(
    ...
    posicion_inicial = posicion_ideologica, # Position in the (first) period of comparison
    posicion_final = posicion_ideologica + diferencia_media, # Position in the (second) period of comparison
